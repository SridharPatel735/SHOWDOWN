    ...
    public partial class GameScreen : UserControl
    {
        ...
        public void HeroHealthCheck()
        {
            ...
            if (heroHealth <= 0)
            {
                ...
                if (direction == "left")
                {
                    heroBox2.BackgroundImage = GameTemplateTest.Properties.Resources.marco_dead_Right;
                }
                else
                {
                    heroBox2.BackgroundImage = GameTemplateTest.Properties.Resources.marco_dead_Left;
                }
                healthLabel.Text = heroHealth + "";
